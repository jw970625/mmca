let funcObj = {
  f_0:function(){
    ...
    tl.to('#section0 .scroll',{opacity:1})
  },
  f_1:function(){
    const tl = gsap.timeline();
    ...
    $(function(){
      $('.count').each(function(){  //각각의 요소들을 반복적으로 순회
        let crt = $(this); //각각의 요소
...
/* 
  ...
  현재 스크롤 위치가 "섹션이 뷰포트에 등장하기 시작할 시점"과 "섹션이 뷰포트를 벗어나기 직전 시점" 사이에 있는지
  그때마다 섹션별 함수 f_i()를 실행 
*/
